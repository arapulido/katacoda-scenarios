...
Then click on the "Graph" button in the logs view to display the log query as a metric.<br/><br/>
</details>
...
In the application, you can find source code that it's listing pods with two
